import { Drawer, List, ListItemIcon, ListItemText, ListItemButton, alpha } from '@material-ui/core';
import { styled } from '@material-ui/core/styles';
import { keyframes } from '@material-ui/styled-engine';

const SidebarAnimationFadeIn = (color: string, transparentColor: string) => keyframes`
  0% {
    width: 110px;
...
const SidebarAnimationFadeOut = (color: string, transparentColor: string) => keyframes`
  0% {
    width: 300px;
    background-color: ${color};
  }
...
const drawerText = '#FFFFFF';
const drawerColor = '#007FFF';
...
export const SidebarDrawer = styled(Drawer, {
  ...
  [theme.breakpoints.up('md')]: {
    ...
    '& .MuiDrawer-paper': {
      ...
      width: 110,
      color: drawerText,
      backgroundColor: alpha(drawerColor, 0),
      ...(drawerAnimation === 'enter' && {
        animation: `${SidebarAnimationFadeIn(drawerColor, alpha(drawerColor, 0))} 0.3s both`,
      }),
      ...(drawerAnimation === 'out' && {
        animation: `${SidebarAnimationFadeOut(drawerColor, alpha(drawerColor, 0))} 0.3s both`,
      }),
